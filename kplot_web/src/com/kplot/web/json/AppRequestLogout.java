...
public class AppRequestLogout extends JSONWrapper{
	public static final int ID = 5;
	public static final String NAME = "AppRequestLogout";
	public String		requestKey;	//요청 키
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppRequestLogout d ){
	...
	public static AppRequestLogout decoding(JSONObject obj) {
		AppRequestLogout wrapper = new AppRequestLogout();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestLogout.NAME);
