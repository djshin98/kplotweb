...
public class AppResponseLogout extends JSONWrapper{
	public static final int ID = 6;
	public static final String NAME = "AppResponseLogout";
	public String		requestKey;	//요청 키
	public String		result;	//요청 처리 결과값
	public String		resultMessage;	//처리 오류 상세 메시지
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppResponseLogout d ){
	...
	public static AppResponseLogout decoding(JSONObject obj) {
		AppResponseLogout wrapper = new AppResponseLogout();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseLogout.NAME);
