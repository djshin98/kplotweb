...
public class AppRequestDataSource extends JSONWrapper{
	public static final int ID = 14;
	public static final String NAME = "AppRequestDataSource";
	public String		requestKey;	//요청 키
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppRequestDataSource d ){
	...
	public static AppRequestDataSource decoding(JSONObject obj) {
		AppRequestDataSource wrapper = new AppRequestDataSource();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestDataSource.NAME);
